...
app_publisher = "Windify Technologies Pvt. Ltd."
app_description = "Future Academy Management System"
...
# Request Events
# ----------------
before_request = ["education.cookie_domain_middleware.set_cookie_domain"]
